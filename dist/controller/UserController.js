...
var GetUsersService_1 = require("../services/GetUsersService");
var UserController = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        createUser = new CreateUserService_1.CreateUserService();
                        return [4 /*yield*/, createUser.execute(userData)];
                    case 1:
                        user = _a.sent();
    ...
    UserController.prototype.show = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var userID, getUsers, users;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userID = request.body.user;
                        getUsers = new GetUsersService_1.GetUsersService();
                        return [4 /*yield*/, getUsers.execute(userID)];
                    case 1:
                        users = _a.sent();
